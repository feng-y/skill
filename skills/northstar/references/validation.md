...
通过：可以使用从同一公开 Goal/verification requirement 推导的少量暗卷或独立 evidence；不得偷偷增加需求。无法隔离的“暗卷”必须降为明卷或换其他受保护 evidence。
...
- S5、S6 必须同时正确，避免“漏 production verification”和“机械 replay”两个方向的偏差；
