...
Expose only material prerequisites, parallel branches, and an explicit join or terminal route. Preserve the ordinary Task contract for write ownership and evidence validity.
