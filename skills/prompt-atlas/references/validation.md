...
12. When Executor results return, Prompt Atlas independently judges the original authoritative Taskbook's Goal / binding constraints / completion claims / Evidence rather than treating “changes done, tests green, checklist complete” as completion proof. Evidence gaps remain gaps. If Goal/contract is unchanged, a failed judgment names the unsupported claim/Evidence/blocker without compiling a repair tasklist or taking over debugging; only new Evidence that changes a material premise / Human choice / binding boundary re-enters affected Write flow.
