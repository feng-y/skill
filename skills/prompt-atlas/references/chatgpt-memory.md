...
- If Memory keeps a prior decision, default, or rejection relevant, preserve its owner, basis, and effect in the owning slot rather than burying it as background.
