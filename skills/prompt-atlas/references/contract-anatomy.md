...
Unknown consequence routing, evidence reduction, and model-owned default rules live in `Shape` in [SKILL.md](../SKILL.md). This file expands only the authority model and Stable Intent closure; it does not own a second routing table.
