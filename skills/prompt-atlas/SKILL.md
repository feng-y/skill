...
2. **Enrich**
   ...
   - For a user-owned material choice, prepare the smallest sufficient decision context from what is already known: the established facts, the part available evidence cannot decide, and the material Goal / Boundary / Success / route consequence of meaningfully different choices. Do not manufacture options when the real decision is not yet sharp, and do not recommend a value judgment that belongs to the user.
