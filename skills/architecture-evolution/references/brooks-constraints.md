...
用相关约束检查 `rules.md` 已形成的 best-known judgement；反证成立就 reject 或缩小 intent，否则只保留真正影响 direction / boundary 的 guard。
...
Brooks 只改变 judgement；最终 Intent 不输出 R1–R6、Risk/Guard/Proof、PASS/RETRY、Health Score 或 challenge 过程。
