...
Install all skills (currently installs Northstar, Unknowns First, Architecture Evolution, and Shape Intent):
...
npx skills@latest add feng-y/skill --skill shape-intent
```
